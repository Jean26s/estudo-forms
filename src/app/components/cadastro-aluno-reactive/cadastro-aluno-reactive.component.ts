...
export class CadastroAlunoReactiveComponent {
  form: FormGroup = new FormGroup({
    ...
    email: new FormControl('', [Validators.required , this.emailEscolar]),
  ...
  emailEscolar(control:AbstractControl):ValidationErrors|null{   //EXEMPLO CRIANDO UM VALIDATOR CUSTOM 
